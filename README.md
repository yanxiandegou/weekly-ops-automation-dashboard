...
| 视频演示位 | 展示项目演示内容 | 当前已接入仓库内置视频文件，可直接播放 |
...
| `assets/videos/weekly-ops-demo.mp4` | 当前页面使用的演示视频文件 |
...
也就是说，上传到 GitHub 后，页面会直接读取仓库中的视频文件，而不是依赖本地磁盘路径。

如果你后面还想替换成别的视频，可以继续改成新的仓库内相对路径，或者改成公开视频地址，例如：
